...
type QueryPublicRoomsOKBody struct {
	...
	// Required: true
	Chunk []*QueryPublicRoomsOKBodyChunkItems `json:"chunk"`
	...
	TotalRoomCountEstimate float64 `json:"total_room_count_estimate,omitempty"`
}

// Validate validates this query public rooms o k body
func (m *QueryPublicRoomsOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *QueryPublicRoomsOKBody) validateChunk(formats strfmt.Registry) error {
...
func (m *QueryPublicRoomsOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *QueryPublicRoomsOKBody) UnmarshalBinary(b []byte) error {
