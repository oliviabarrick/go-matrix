...
type DeleteDeviceUnauthorizedBody struct {
	...
	// Required: true
	Flows []*DeleteDeviceUnauthorizedBodyFlowsItems `json:"flows"`
...
func (m *DeleteDeviceUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteDeviceUnauthorizedBody) validateFlows(formats strfmt.Registry) error {
...
func (m *DeleteDeviceUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DeleteDeviceUnauthorizedBody) UnmarshalBinary(b []byte) error {
