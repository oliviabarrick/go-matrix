...
type InitialSyncOKBodyRoomsItemsInviteAllOf0 struct {
	...
	InviteRoomState []*InitialSyncOKBodyRoomsItemsInviteAllOf0InviteRoomStateItems `json:"invite_room_state"`
...
func (m *InitialSyncOKBodyRoomsItemsInviteAllOf0) validateInviteRoomState(formats strfmt.Registry) error {
