...
type DeactivateAccountUnauthorizedBody struct {
	...
	// Required: true
	Flows []*DeactivateAccountUnauthorizedBodyFlowsItems `json:"flows"`
...
func (m *DeactivateAccountUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeactivateAccountUnauthorizedBody) validateFlows(formats strfmt.Registry) error {
...
func (m *DeactivateAccountUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DeactivateAccountUnauthorizedBody) UnmarshalBinary(b []byte) error {
