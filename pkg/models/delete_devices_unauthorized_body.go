...
type DeleteDevicesUnauthorizedBody struct {
	...
	// Required: true
	Flows []*DeleteDevicesUnauthorizedBodyFlowsItems `json:"flows"`
...
func (m *DeleteDevicesUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteDevicesUnauthorizedBody) validateFlows(formats strfmt.Registry) error {
...
func (m *DeleteDevicesUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DeleteDevicesUnauthorizedBody) UnmarshalBinary(b []byte) error {
