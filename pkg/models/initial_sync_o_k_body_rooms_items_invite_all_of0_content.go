...
type InitialSyncOKBodyRoomsItemsInviteAllOf0Content struct {
	...
	// unsigned
	Unsigned *InitialSyncOKBodyRoomsItemsInviteAllOf0ContentUnsigned `json:"unsigned,omitempty"`
}
...
func (m *InitialSyncOKBodyRoomsItemsInviteAllOf0Content) validateUnsigned(formats strfmt.Registry) error {
