...
func (m *SetPushRuleBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SetPushRuleBadRequestBody) validateErrcode(formats strfmt.Registry) error {
...
func (m *SetPushRuleBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SetPushRuleBadRequestBody) UnmarshalBinary(b []byte) error {
