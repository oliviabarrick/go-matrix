...
// GetFilterOKBodyAllOf0RoomEphemeralAllOf0 get filter o k body all of0 room ephemeral all of0
...
type GetFilterOKBodyAllOf0RoomEphemeralAllOf0 struct {
	...
	GetFilterOKBodyAllOf0RoomEphemeralAllOf0AllOf1
}
...
func (m *GetFilterOKBodyAllOf0RoomEphemeralAllOf0) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 GetFilterOKBodyAllOf0RoomEphemeralAllOf0AllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.GetFilterOKBodyAllOf0RoomEphemeralAllOf0AllOf1 = aO1
...
func (m GetFilterOKBodyAllOf0RoomEphemeralAllOf0) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.GetFilterOKBodyAllOf0RoomEphemeralAllOf0AllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *GetFilterOKBodyAllOf0RoomEphemeralAllOf0) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with GetFilterOKBodyAllOf0RoomEphemeralAllOf0AllOf1
	if err := m.GetFilterOKBodyAllOf0RoomEphemeralAllOf0AllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
