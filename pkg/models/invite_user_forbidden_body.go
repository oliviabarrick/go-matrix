...
func (m *InviteUserForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InviteUserForbiddenBody) validateErrcode(formats strfmt.Registry) error {
...
func (m *InviteUserForbiddenBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *InviteUserForbiddenBody) UnmarshalBinary(b []byte) error {
