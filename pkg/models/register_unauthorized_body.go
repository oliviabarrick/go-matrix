...
type RegisterUnauthorizedBody struct {
	...
	// Required: true
	Flows []*RegisterUnauthorizedBodyFlowsItems `json:"flows"`
...
func (m *RegisterUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RegisterUnauthorizedBody) validateFlows(formats strfmt.Registry) error {
...
func (m *RegisterUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RegisterUnauthorizedBody) UnmarshalBinary(b []byte) error {
