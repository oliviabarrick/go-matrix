...
func (m *CheckUsernameAvailabilityTooManyRequestsBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CheckUsernameAvailabilityTooManyRequestsBody) validateErrcode(formats strfmt.Registry) error {
...
func (m *CheckUsernameAvailabilityTooManyRequestsBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CheckUsernameAvailabilityTooManyRequestsBody) UnmarshalBinary(b []byte) error {
