...
func (m *RegisterBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RegisterBadRequestBody) validateErrcode(formats strfmt.Registry) error {
...
func (m *RegisterBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RegisterBadRequestBody) UnmarshalBinary(b []byte) error {
