...
func (m *CreateRoomBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateRoomBadRequestBody) validateErrcode(formats strfmt.Registry) error {
...
func (m *CreateRoomBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateRoomBadRequestBody) UnmarshalBinary(b []byte) error {
