...
func (m *LoginBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LoginBadRequestBody) validateErrcode(formats strfmt.Registry) error {
...
func (m *LoginBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LoginBadRequestBody) UnmarshalBinary(b []byte) error {
