...
func (m *SetRoomAliasConflictBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SetRoomAliasConflictBody) validateErrcode(formats strfmt.Registry) error {
...
func (m *SetRoomAliasConflictBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SetRoomAliasConflictBody) UnmarshalBinary(b []byte) error {
