...
func (m *GetTokenOwnerUnauthorizedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetTokenOwnerUnauthorizedBody) validateErrcode(formats strfmt.Registry) error {
...
func (m *GetTokenOwnerUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetTokenOwnerUnauthorizedBody) UnmarshalBinary(b []byte) error {
