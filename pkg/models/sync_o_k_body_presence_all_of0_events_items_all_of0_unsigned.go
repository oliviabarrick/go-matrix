...
// SyncOKBodyPresenceAllOf0EventsItemsAllOf0Unsigned Unsigned
//
// Information about this event which was not sent by the originating homeserver
// swagger:model syncOKBodyPresenceAllOf0EventsItemsAllOf0Unsigned
type SyncOKBodyPresenceAllOf0EventsItemsAllOf0Unsigned struct {
...
// Validate validates this sync o k body presence all of0 events items all of0 unsigned
func (m *SyncOKBodyPresenceAllOf0EventsItemsAllOf0Unsigned) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *SyncOKBodyPresenceAllOf0EventsItemsAllOf0Unsigned) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SyncOKBodyPresenceAllOf0EventsItemsAllOf0Unsigned) UnmarshalBinary(b []byte) error {
	var res SyncOKBodyPresenceAllOf0EventsItemsAllOf0Unsigned
