...
func (m *ForgetRoomBadRequestBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ForgetRoomBadRequestBody) validateErrcode(formats strfmt.Registry) error {
...
func (m *ForgetRoomBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ForgetRoomBadRequestBody) UnmarshalBinary(b []byte) error {
