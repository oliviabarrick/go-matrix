...
func (m *KickForbiddenBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *KickForbiddenBody) validateErrcode(formats strfmt.Registry) error {
...
func (m *KickForbiddenBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *KickForbiddenBody) UnmarshalBinary(b []byte) error {
