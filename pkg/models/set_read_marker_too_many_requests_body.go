...
func (m *SetReadMarkerTooManyRequestsBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SetReadMarkerTooManyRequestsBody) validateErrcode(formats strfmt.Registry) error {
...
func (m *SetReadMarkerTooManyRequestsBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SetReadMarkerTooManyRequestsBody) UnmarshalBinary(b []byte) error {
