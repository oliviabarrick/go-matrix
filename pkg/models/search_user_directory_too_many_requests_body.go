...
func (m *SearchUserDirectoryTooManyRequestsBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SearchUserDirectoryTooManyRequestsBody) validateErrcode(formats strfmt.Registry) error {
...
func (m *SearchUserDirectoryTooManyRequestsBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SearchUserDirectoryTooManyRequestsBody) UnmarshalBinary(b []byte) error {
