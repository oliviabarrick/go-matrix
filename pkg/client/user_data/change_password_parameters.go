...
type ChangePasswordParams struct {
	...
	/*Body*/
	Body *models.ChangePasswordParamsBody
...
func (o *ChangePasswordParams) WithBody(body *models.ChangePasswordParamsBody) *ChangePasswordParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the change password params
func (o *ChangePasswordParams) SetBody(body *models.ChangePasswordParamsBody) {
	o.Body = body
}
