...
Use the Docker image `justinbarrick/matrixctl:v0.0.8`

## Download binary

Download the binary: `curl https://github.com/justinbarrick/go-matrix/releases/download/v0.0.8/matrixctl -O && chmod +x matrixctl`.
