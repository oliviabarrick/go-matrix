...
func (o *GetDisplayNameOK) Error() string {
	return fmt.Sprintf("[GET /_matrix/client/r0/profile/{userId}/displayname][%d] getDisplayNameOK  %+v", 200, o.Payload)
}
...
func (o *GetDisplayNameNotFound) Error() string {
	return fmt.Sprintf("[GET /_matrix/client/r0/profile/{userId}/displayname][%d] getDisplayNameNotFound ", 404)
}
