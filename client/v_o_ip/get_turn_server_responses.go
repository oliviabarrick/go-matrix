...
func (o *GetTurnServerOK) Error() string {
	return fmt.Sprintf("[GET /_matrix/client/r0/voip/turnServer][%d] getTurnServerOK  %+v", 200, o.Payload)
}
...
func (o *GetTurnServerTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /_matrix/client/r0/voip/turnServer][%d] getTurnServerTooManyRequests  %+v", 429, o.Payload)
}
