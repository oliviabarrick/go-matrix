...
func (o *CreateRoomOK) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/createRoom][%d] createRoomOK  %+v", 200, o.Payload)
}
...
func (o *CreateRoomBadRequest) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/createRoom][%d] createRoomBadRequest ", 400)
}
