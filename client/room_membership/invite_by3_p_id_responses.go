...
func (o *InviteBy3PIDOK) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/rooms/{roomId}/invite][%d] inviteBy3PIdOK  %+v", 200, o.Payload)
}
...
func (o *InviteBy3PIDForbidden) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/rooms/{roomId}/invite][%d] inviteBy3PIdForbidden ", 403)
}
...
func (o *InviteBy3PIDTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/rooms/{roomId}/invite][%d] inviteBy3PIdTooManyRequests  %+v", 429, o.Payload)
}
