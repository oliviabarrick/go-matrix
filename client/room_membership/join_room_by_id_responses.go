...
func (o *JoinRoomByIDOK) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/rooms/{roomId}/join][%d] joinRoomByIdOK  %+v", 200, o.Payload)
}
...
func (o *JoinRoomByIDForbidden) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/rooms/{roomId}/join][%d] joinRoomByIdForbidden ", 403)
}
...
func (o *JoinRoomByIDTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/rooms/{roomId}/join][%d] joinRoomByIdTooManyRequests  %+v", 429, o.Payload)
}
