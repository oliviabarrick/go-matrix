...
func (o *InviteUserOK) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/rooms/{roomId}/invite ][%d] inviteUserOK  %+v", 200, o.Payload)
}
...
func (o *InviteUserForbidden) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/rooms/{roomId}/invite ][%d] inviteUserForbidden ", 403)
}
...
func (o *InviteUserTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/rooms/{roomId}/invite ][%d] inviteUserTooManyRequests  %+v", 429, o.Payload)
}
