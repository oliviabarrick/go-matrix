...
func (o *LoginOK) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/login][%d] loginOK  %+v", 200, o.Payload)
}
...
func (o *LoginBadRequest) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/login][%d] loginBadRequest ", 400)
}
...
func (o *LoginForbidden) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/login][%d] loginForbidden ", 403)
}
...
func (o *LoginTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/login][%d] loginTooManyRequests  %+v", 429, o.Payload)
}
