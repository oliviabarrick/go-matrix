...
func (o *GetRoomIDByAliasOK) Error() string {
	return fmt.Sprintf("[GET /_matrix/client/r0/directory/room/{roomAlias}][%d] getRoomIdByAliasOK  %+v", 200, o.Payload)
}
...
func (o *GetRoomIDByAliasNotFound) Error() string {
	return fmt.Sprintf("[GET /_matrix/client/r0/directory/room/{roomAlias}][%d] getRoomIdByAliasNotFound ", 404)
}
