...
func (o *UpdateDeviceOK) Error() string {
	return fmt.Sprintf("[PUT /_matrix/client/r0/devices/{deviceId}][%d] updateDeviceOK  %+v", 200, o.Payload)
}
...
func (o *UpdateDeviceNotFound) Error() string {
	return fmt.Sprintf("[PUT /_matrix/client/r0/devices/{deviceId}][%d] updateDeviceNotFound ", 404)
}
