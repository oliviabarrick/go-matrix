...
func (o *SetPresenceOK) Error() string {
	return fmt.Sprintf("[PUT /_matrix/client/r0/presence/{userId}/status][%d] setPresenceOK  %+v", 200, o.Payload)
}
...
func (o *SetPresenceTooManyRequests) Error() string {
	return fmt.Sprintf("[PUT /_matrix/client/r0/presence/{userId}/status][%d] setPresenceTooManyRequests  %+v", 429, o.Payload)
}
