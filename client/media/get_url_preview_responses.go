...
func (o *GetURLPreviewOK) Error() string {
	return fmt.Sprintf("[GET /_matrix/media/r0/preview_url][%d] getUrlPreviewOK  %+v", 200, o.Payload)
}
...
func (o *GetURLPreviewTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /_matrix/media/r0/preview_url][%d] getUrlPreviewTooManyRequests  %+v", 429, o.Payload)
}
