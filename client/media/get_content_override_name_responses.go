...
func (o *GetContentOverrideNameOK) Error() string {
	return fmt.Sprintf("[GET /_matrix/media/r0/download/{serverName}/{mediaId}/{fileName}][%d] getContentOverrideNameOK  %+v", 200, o.Payload)
}
...
func (o *GetContentOverrideNameTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /_matrix/media/r0/download/{serverName}/{mediaId}/{fileName}][%d] getContentOverrideNameTooManyRequests  %+v", 429, o.Payload)
}
