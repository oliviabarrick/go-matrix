...
func (o *UploadContentOK) Error() string {
	return fmt.Sprintf("[POST /_matrix/media/r0/upload][%d] uploadContentOK  %+v", 200, o.Payload)
}
...
func (o *UploadContentTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /_matrix/media/r0/upload][%d] uploadContentTooManyRequests  %+v", 429, o.Payload)
}
