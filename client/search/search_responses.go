...
func (o *SearchOK) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/search][%d] searchOK  %+v", 200, o.Payload)
}
...
func (o *SearchBadRequest) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/search][%d] searchBadRequest ", 400)
}
...
func (o *SearchTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/search][%d] searchTooManyRequests  %+v", 429, o.Payload)
}
