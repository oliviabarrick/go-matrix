...
func (o *RoomInitialSyncOK) Error() string {
	return fmt.Sprintf("[GET /_matrix/client/r0/rooms/{roomId}/initialSync][%d] roomInitialSyncOK  %+v", 200, o.Payload)
}
...
func (o *RoomInitialSyncForbidden) Error() string {
	return fmt.Sprintf("[GET /_matrix/client/r0/rooms/{roomId}/initialSync][%d] roomInitialSyncForbidden ", 403)
}
