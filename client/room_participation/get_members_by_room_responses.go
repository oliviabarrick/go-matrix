...
func (o *GetMembersByRoomOK) Error() string {
	return fmt.Sprintf("[GET /_matrix/client/r0/rooms/{roomId}/members][%d] getMembersByRoomOK  %+v", 200, o.Payload)
}
...
func (o *GetMembersByRoomForbidden) Error() string {
	return fmt.Sprintf("[GET /_matrix/client/r0/rooms/{roomId}/members][%d] getMembersByRoomForbidden ", 403)
}
