...
func (o *PostReceiptOK) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/rooms/{roomId}/receipt/{receiptType}/{eventId}][%d] postReceiptOK  %+v", 200, o.Payload)
}
...
func (o *PostReceiptTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /_matrix/client/r0/rooms/{roomId}/receipt/{receiptType}/{eventId}][%d] postReceiptTooManyRequests  %+v", 429, o.Payload)
}
