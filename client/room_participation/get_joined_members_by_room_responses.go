...
func (o *GetJoinedMembersByRoomOK) Error() string {
	return fmt.Sprintf("[GET /_matrix/client/r0/rooms/{roomId}/joined_members][%d] getJoinedMembersByRoomOK  %+v", 200, o.Payload)
}
...
func (o *GetJoinedMembersByRoomForbidden) Error() string {
	return fmt.Sprintf("[GET /_matrix/client/r0/rooms/{roomId}/joined_members][%d] getJoinedMembersByRoomForbidden ", 403)
}
