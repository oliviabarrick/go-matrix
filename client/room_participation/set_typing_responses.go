...
func (o *SetTypingOK) Error() string {
	return fmt.Sprintf("[PUT /_matrix/client/r0/rooms/{roomId}/typing/{userId}][%d] setTypingOK  %+v", 200, o.Payload)
}
...
func (o *SetTypingTooManyRequests) Error() string {
	return fmt.Sprintf("[PUT /_matrix/client/r0/rooms/{roomId}/typing/{userId}][%d] setTypingTooManyRequests  %+v", 429, o.Payload)
}
